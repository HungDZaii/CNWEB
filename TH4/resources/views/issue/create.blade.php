    ...
    <div class="container">
        ...
        <form action="{{ route('issue.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3 form-group">
                ...
                <input class="form-control @error('reporter_by') is-invalid @enderror" type="text" name="reporter_by" id="reporter_by" value="{{ old('reporter_by') }}">
                @error('reporter_by')
            ...
            <div class="mb-3 form-group">
                ...
                <input class="form-control @error('dareporter_date') is-invalid @enderror" type="datetime-local" name="reporter_date" id="reporter_date" value="{{ old('reporter_date') }}">
                @error('reporter_date')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3 form-group">
                ...
                <input class="form-control @error('urgency') is-invalid @enderror" type="text" name="urgency" id="urgency" value="{{ old('urgency') }}">
                @error('urgency')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
