        ...
        <body>
            <form action="{{ route('issue.update', $Issue->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 form-group">
                    ...
                    <input class="form-control @error('urgency') is-invalid @enderror" type="text" name="urgency" id="urgency" value="{{ old('urgency',$Issue->urgency) }}">
                    @error('urgency')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 form-group">
                    ...
                    <input class="form-control @error('status') is-invalid @enderror" type="text" name="status" id="status" value="{{ old('status', $Issue->status) }}">
                    @error('status')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
